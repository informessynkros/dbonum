  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Badge de contador */}
        {hasSelection && (
          <div className="bg-teal-600 text-white text-xs font-bold px-1.5 py-0.5 rounded-full min-w-5 text-center">
            {selectedValues.size}
          </div>
        )}
      ...
      {isOpen && createPortal(
        <>
          ...
          <div
            ref={backdropRef}
            className="fixed inset-0 bg-black/5 index_z_1"
            onClick={handleClose}
            style={{ opacity: 0 }}
          />
          ...
          <div
            ref={dropdownRef}
            className="fixed bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden index_z_2"
            style={{
              opacity: 0,
            ...
            <div ref={contentRef}>
              ...
              <div className="p-3 border-t border-gray-100 bg-gray-50/50">
                <div className="flex justify-between gap-2">
                  ...
                  <button
                    onClick={handleClose}
                    className="text-sm bg-teal-600 text-white px-4 py-1.5 rounded-lg cursor-pointer
