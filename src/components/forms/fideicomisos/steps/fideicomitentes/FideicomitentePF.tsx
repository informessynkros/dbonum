...
interface FideicomitentePFProps {
  index: number
  control: Control<any>
...
const FideicomitentePF = ({ index, control, fieldName = 'fideicomitentes' }: FideicomitentePFProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {/* Nombre */}
      <Controller
        name={`${fieldName}.${index}.datos.nombre`}
        control={control}
      ...
      {/* Apellido Paterno */}
      <Controller
        name={`${fieldName}.${index}.datos.apellidoPaterno`}
        control={control}
        render={({ field, fieldState: { error } }) => (
          <MessageToasty
            {...field}
      ...
      {/* Apellido Materno */}
      <Controller
        name={`${fieldName}.${index}.datos.apellidoMaterno`}
        control={control}
        render={({ field, fieldState: { error } }) => (
          <MessageToasty
            {...field}
      ...
      {/* Género */}
      <Controller
        name={`${fieldName}.${index}.datos.genero`}
        control={control}
      ...
      {/* Fecha de Nacimiento */}
      <Controller
        name={`${fieldName}.${index}.datos.fechaNacimiento`}
        control={control}
        render={({ field, fieldState: { error } }) => (
          <MessageToasty
            {...field}
      ...
      {/* País de Nacimiento */}
      <Controller
        name={`${fieldName}.${index}.datos.paisNacimiento`}
        control={control}
        render={({ field: { onChange }, fieldState: { error } }) => (
          <SelectMultiple
            options={PAISES}
      ...
      <Controller
        name={`${fieldName}.${index}.datos.entidadNacimiento`}
        control={control}
        render={({ field: { onChange }, fieldState: { error } }) => (
          <SelectMultiple
      ...
      {/* Ocupación */}
      <Controller
        name={`${fieldName}.${index}.datos.ocupacion`}
        control={control}
        render={({ field: { onChange }, fieldState: { error } }) => (
          <SelectMultiple
      ...
      {/* CURP */}
      <Controller
        name={`${fieldName}.${index}.datos.curp`}
        control={control}
        render={({ field, fieldState: { error } }) => (
          <MessageToasty
            {...field}
...
export default FideicomitentePF